    ...
    return (
     ...
     <div className="flex flex-col items-center pb-10 pt-10">
          ...
          <div className="flex mt-4 md:mt-6">
               ...
               focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Dashboard</Link>

               <a href="#" onClick={handleLogout} className="py-2 px-4 ms-2 text-sm font-medium text-gray-900 
