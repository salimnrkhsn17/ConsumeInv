    ...
    useEffect(() => {
        ...
        .catch(err => {
            ...
            if (err.response.status == 401) {
                navigation('/login?message=' + encodeURIComponent('Anda belum login!'));
            }
                            ...
                            <div class="mb-6">
                                {
                                    item.tag == "select" ? (
                                        <>
                                            ...
                                            <select id="category" name={index} class="bg-gray-50 border border-gray-300 text-gray-900 text-sm
                                             rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-600
                                             dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500
                                             dark:focus:border-primary-500" value={dataDetail[index]} onChange={handleInputChange}>
                                                {
                                        ...
                                        <>
                                            ...
                                            <input type={item.type} name={index} id="name" class="bg-gray-50 border border-gray-300 text-gray-900
                                            text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600
                                            dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500
                                            dark:focus:border-primary-500" value={dataDetail[index]} onChange={handleInputChange} />
                                        </>
                                    )
